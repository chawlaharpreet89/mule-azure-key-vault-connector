package com.pwc.mule.connector.akv.provider.internal.operation;
...
import com.pwc.mule.connector.akv.provider.api.error.AzureKeyVaultErrorTypeProvider;
import com.pwc.mule.connector.akv.provider.internal.connection.AkvConnection;
...
//get secret list -- *** Harpreet Chawla ***
	
	 @Throws(AzureKeyVaultErrorTypeProvider.class)
	  @MediaType(value = ANY, strict = false)
	  public SecretList getSecretList(@Config AkvConfiguration configuration,
	      @Connection AkvConnection connection) throws DefaultMuleException {
			/*
			 * Secret s= new Secret(); s.setSecretName(secretName1);
			 */
	    return connection.getSecretList();
	  }
